...
public class ElementosWeb {
	...
	private By validarNome = By.cssSelector(
			"#__next > footer > div > div > div.order-sm-2.mb-4.mb-sm-0.ml-lg-auto.col-lg-2.col-sm-3 > h4");
	...
	private By validarResumoVaga = By.cssSelector(
			"#content > div:nth-child(2) > div > div > div.col-lg-4 > div > div.border-0.shadow-sm.mb-3.card > header > div > h3");
	private By CandidatarSe = By.cssSelector(
			"#content > div:nth-child(2) > div > div > div.col-lg-4 > div > div.border-0.shadow-sm.mb-3.card > div > div.text-center > div > button");
	private By validarModal = By.cssSelector(
			"body > div.fade.apply-modal.modal.show > div > div > div.bg-light.py-3.px-5.modal-header > div");
	...
	public By getCandidatarSe() {
		return CandidatarSe;
	}

	public void setCandidatarSe(By candidatarSe) {
		CandidatarSe = candidatarSe;
	}

	public By getValidarModal() {
		return validarModal;
	}

	public void setValidarModal(By validarModal) {
		this.validarModal = validarModal;
	}
}
